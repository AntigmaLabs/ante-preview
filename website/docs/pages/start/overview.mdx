...
<CardGroup cols={3}>
  <Card title="Lightweight agent core">
  ...
  <Card title="Native local models">
...
<CardGroup cols={2}>
  ...
  <Card title="Interactive TUI" href="/usage/tui">
  ...
  <Card title="Offline Mode" href="/offline">
    Run Ante fully offline with local models.
  </Card>
  <Card title="Agent Organization" href="/agent-org">
    How Ante self-organizes agents for complex tasks.
  </Card>
  <Card title="Benchmarks" href="/benchmarks/eval">
