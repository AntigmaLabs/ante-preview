...
```bash
ante --offline-model ~/.ante/models/qwen2.5-coder-7b-q4.gguf "Explain this code"
```
...
```bash
ante serve --ws 127.0.0.1:9000 --offline-model ~/.ante/models/qwen2.5-coder-7b-q4.gguf
```
