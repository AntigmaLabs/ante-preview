...
<div className="benchmark-gallery">
  ...
  <figure className="benchmark-shot">
    ...
    />
    <figcaption>
      <strong>Terminal Bench 2.0.</strong> Ante ranked second overall on January 6, 2026 and was the highest-ranked Gemini-based agent in the displayed leaderboard.
    </figcaption>
  </figure>
</div>
