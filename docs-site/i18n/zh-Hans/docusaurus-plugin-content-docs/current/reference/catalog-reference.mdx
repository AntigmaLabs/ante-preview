...
### Ali Coding Plan（阿里代码计划） {#ali-coding-plan}
...
需要开通[阿里云百炼代码计划订阅](https://help.aliyun.com/zh/model-studio/coding-plan)并获取 API 密钥（格式如：`sk-sp-xxxxx`）。内置提供商采用 Anthropic 协议端点。部分模型仅在 OpenAI 兼容端点提供 —— 可通过自定义目录项添加接入：
